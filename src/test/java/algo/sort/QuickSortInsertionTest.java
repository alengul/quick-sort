...
public class QuickSortInsertionTest {
    ...
    private final QuickSort quickSortMedian = new QuickSortInsertion(true);
    private final QuickSort quickSort = new QuickSortInsertion(false);
    ...
    public void Test() {
        ...
        System.out.println("Local insertion median: " + (System.currentTimeMillis() - startTime));
        System.out.println(comparator.getCompareTimes());

        comparator.resetCompares();
        startTime = System.currentTimeMillis();
        quickSort.sort(arr2, comparator);
        System.out.println("Local insertion without median: " + (System.currentTimeMillis() - startTime));
        System.out.println(comparator.getCompareTimes());
